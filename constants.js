...
export const GRADE_DOCS_NODE = "gradeDocuments";
export const REWRITE_NODE = "rewrite";
...
// Prompts
export const GRADE_PROMPT_TEMPLATE = `You are a grader assessing relevance of retrieved docs to a user question.
